...
public class SQLQueries {
    ...
    public static final String UPDATE_AUTHORIZATION_CODE_HASH = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE SET " +
            "AUTHORIZATION_CODE_HASH=? WHERE AUTHORIZATION_CODE=?";

    public static final String CHECK_AUTHORIZATION_CODE_HASH = "SELECT AUTHORIZATION_CODE_HASH FROM " +
            "IDN_OAUTH2_AUTHORIZATION_CODE WHERE AUTHORIZATION_CODE_HASH=?";

    public static final String CHECK_REFRESH_TOKEN_HASH = "SELECT REFRESH_TOKEN_HASH FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN WHERE REFRESH_TOKEN_HASH=?";
