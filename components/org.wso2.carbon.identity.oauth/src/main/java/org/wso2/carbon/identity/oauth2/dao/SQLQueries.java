...
public class SQLQueries {
    ...
    public static final String UPDATE_ACCESS_TOKEN ="UPDATE IDN_OAUTH2_ACCESS_TOKEN " +
            "SET ACCESS_TOKEN=?, ACCESS_TOKEN_HASH=? WHERE ACCESS_TOKEN=? AND CONSUMER_KEY_ID =(SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?)";

    public static final String UPDATE_REFRESH_TOKEN ="UPDATE IDN_OAUTH2_ACCESS_TOKEN " +
            "SET REFRESH_TOKEN=?,REFRESH_TOKEN_HASH=? WHERE REFRESH_TOKEN=? AND CONSUMER_KEY_ID =(SELECT ID FROM " + "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?)";
