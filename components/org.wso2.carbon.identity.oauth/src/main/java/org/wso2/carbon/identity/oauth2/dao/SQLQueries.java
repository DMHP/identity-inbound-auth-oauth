...
public class SQLQueries {
    ...
    public static final String STORE_AUTHORIZATION_CODE_WITH_PKCE_WITH_HASH = "INSERT INTO  "
    ...
    public static final String VALIDATE_AUTHZ_CODE_WITH_PKCE_WITH_HASH = "SELECT AUTHZ_USER, USER_DOMAIN, TENANT_ID, "
            + "SCOPE, " +
            "CALLBACK_URL, TIME_CREATED,VALIDITY_PERIOD, STATE, TOKEN_ID, AUTHORIZATION_CODE, CODE_ID, SUBJECT_IDENTIFIER, " +
            "PKCE_CODE_CHALLENGE, PKCE_CODE_CHALLENGE_METHOD FROM IDN_OAUTH2_AUTHORIZATION_CODE WHERE " +
            "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND "
    ...
    public static final String RETRIEVE_CODE_ID_BY_AUTHORIZATION_CODE_WITH_HASH = "SELECT CODE_ID FROM " +
    ...
    public static final String UPDATE_AUTHORIZATION_CODE = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE SET " +
            "AUTHORIZATION_CODE=?, AUTHORIZATION_CODE_HASH=? WHERE AUTHORIZATION_CODE=?";

    public static final String CHECK_AUTHORIZATION_CODE = "SELECT AUTHORIZATION_CODE FROM " +
            "IDN_OAUTH2_AUTHORIZATION_CODE WHERE AUTHORIZATION_CODE=?";

    public static final String CHECK_REFRESH_TOKEN = "SELECT REFRESH_TOKEN FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN WHERE REFRESH_TOKEN=?";

    public static final String CHECK_ACCESS_TOKEN = "SELECT ACCESS_TOKEN FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN WHERE ACCESS_TOKEN=?";
    ...
    public static final String DEACTIVATE_AUTHZ_CODE_AND_INSERT_CURRENT_TOKEN_WITH_HASH = "UPDATE "
            + "IDN_OAUTH2_AUTHORIZATION_CODE SET " +
            "STATE='INACTIVE', TOKEN_ID=?" +
            " WHERE AUTHORIZATION_CODE_HASH= ?";

    public static final String UPDATE_ACCESS_TOKEN ="UPDATE IDN_OAUTH2_ACCESS_TOKEN " +
            "SET ACCESS_TOKEN=?, ACCESS_TOKEN_HASH=? WHERE ACCESS_TOKEN=?";

    public static final String UPDATE_REFRESH_TOKEN ="UPDATE IDN_OAUTH2_ACCESS_TOKEN " +
            "SET REFRESH_TOKEN=?,REFRESH_TOKEN_HASH=? WHERE REFRESH_TOKEN=?";
...
//            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";
    ...
    public static final String REVOKE_ACCESS_TOKEN_WITH_HASH = "UPDATE IDN_OAUTH2_ACCESS_TOKEN SET TOKEN_STATE=?, " +
    ...
    public static final String UPDATE_AUTHORIZATION_CODE_STATE_WITH_HASH = "UPDATE IDN_OAUTH2_AUTHORIZATION_CODE SET "
            + "STATE=? " +
            "WHERE AUTHORIZATION_CODE_HASH=?";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_HASH_MYSQL = "SELECT ACCESS_TOKEN, "
            + "AUTHZ_USER,"
            + " " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM ( " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_DB2SQL = "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND " +
            "REFRESH_TOKEN = ? ORDER BY TIME_CREATED DESC FETCH FIRST 1 ROWS ONLY) ACCESS_TOKEN_SELECTED LEFT JOIN " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";
    ...
    public static final String INSERT_OAUTH2_ACCESS_TOKEN_WITH_HASH = "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN "
            + "(ACCESS_TOKEN, " +
            "REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TIME_CREATED, " +
            "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_HASH_MYSQL =
            "SELECT ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH FROM " + "IDN_OAUTH2_ACCESS_TOKEN LIMIT 1";

    public static final String RETRIEVE_ACCESS_TOKEN_HASH_DB2SQL =
            "SELECT ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH FROM" + " "
                    + "IDN_OAUTH2_ACCESS_TOKEN FETCH FIRST 1 ROWS ONLY";

    public static final String RETRIEVE_ACCESS_TOKEN_HASH_MSSQL =
            "SELECT TOP 1 ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH FROM " + "IDN_OAUTH2_ACCESS_TOKEN";

    public static final String RETRIEVE_ACCESS_TOKEN_HASH_INFORMIX =
            "SELECT FIRST 1 ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH FROM " + "IDN_OAUTH2_ACCESS_TOKEN";

    public static final String RETRIEVE_ACCESS_TOKEN_HASH_ORACLE =
            "SELECT ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH FROM " + "IDN_OAUTH2_ACCESS_TOKEN WHERE ROWNUM < 2";

    public static final String RETRIEVE_AUTHORIZATION_CODE_HASH_MYSQL =
            "SELECT AUTHORIZATION_CODE_HASH FROM " + "IDN_OAUTH2_AUTHORIZATION_CODE LIMIT 1";

    public static final String RETRIEVE_AUTHORIZATION_CODE_HASH_DB2SQL =
            "SELECT AUTHORIZATION_CODE_HASH FROM" + " " + "IDN_OAUTH2_AUTHORIZATION_CODE FETCH FIRST 1 ROWS ONLY";

    public static final String RETRIEVE_AUTHORIZATION_CODE_HASH_MSSQL =
            "SELECT TOP 1 AUTHORIZATION_CODE_HASH FROM " + "IDN_OAUTH2_AUTHORIZATION_CODE";

    public static final String RETRIEVE_AUTHORIZATION_CODE_HASH_INFORMIX =
            "SELECT FIRST 1 AUTHORIZATION_CODE_HASH FROM " + "IDN_OAUTH2_AUTHORIZATION_CODE";

    public static final String RETRIEVE_AUTHORIZATION_CODE_HASH_ORACLE =
            "SELECT AUTHORIZATION_CODE_HASH FROM " + "IDN_OAUTH2_AUTHORIZATION_CODE WHERE ROWNUM < 2";

    public static final String RETRIEVE_CONSUMER_SECRET_HASH_MYSQL =
            "SELECT CONSUMER_SECRET_HASH FROM " + "IDN_OAUTH_CONSUMER_APPS LIMIT 1";

    public static final String RETRIEVE_CONSUMER_SECRET_HASH_DB2SQL =
            "SELECT CONSUMER_SECRET_HASH FROM" + " " + "IDN_OAUTH_CONSUMER_APPS FETCH FIRST 1 ROWS ONLY";

    public static final String RETRIEVE_CONSUMER_SECRET_HASH_MSSQL =
            "SELECT TOP 1 CONSUMER_SECRET_HASH FROM " + "IDN_OAUTH_CONSUMER_APPS";

    public static final String RETRIEVE_CONSUMER_SECRET_HASH_INFORMIX =
            "SELECT FIRST 1 CONSUMER_SECRET_HASH FROM " + "IDN_OAUTH_CONSUMER_APPS";

    public static final String RETRIEVE_CONSUMER_SECRET_HASH_ORACLE =
