...
public class SQLQueries {
    ...
    public static class OAuthAppDAOSQLQueries {
        ...
        public static final String ADD_OAUTH_APP_WITH_PKCE_WITH_HASH = "INSERT INTO IDN_OAUTH_CONSUMER_APPS " +
                "(CONSUMER_KEY, CONSUMER_SECRET, USERNAME, TENANT_ID, USER_DOMAIN, APP_NAME, OAUTH_VERSION, "
                + "CALLBACK_URL, GRANT_TYPES, PKCE_MANDATORY, PKCE_SUPPORT_PLAIN, CONSUMER_SECRET_HASH) VALUES (?,?,?,"
                + "?,?,?,?,?,?,?,?,?) ";
        ...
        public static final String UPDATE_CONSUMER_SECRET ="UPDATE IDN_OAUTH_CONSUMER_APPS " +
                "SET CONSUMER_SECRET=?, CONSUMER_SECRET_HASH=? WHERE CONSUMER_KEY=?";
        ...
        public static final String UPDATE_CONSUMER_APP_WITH_PKCE_WITH_HASH = "UPDATE IDN_OAUTH_CONSUMER_APPS SET "
                + "APP_NAME=?, CALLBACK_URL=?, GRANT_TYPES=?, " +
                "PKCE_MANDATORY=?, PKCE_SUPPORT_PLAIN=? WHERE CONSUMER_KEY=? AND CONSUMER_SECRET_HASH=?";
